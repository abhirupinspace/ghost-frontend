...
export const exploreTokens: ExploreToken[] = [
  ...
  { id: "sol", name: "Solana", symbol: "SOL", price: 87.98, change1h: 0.91, change1d: 10.79, fdv: 52.8e9, volume: 10.3e6, marketCap: 42.1e9, tvl: 89.5e6, description: "Solana is a high-performance blockchain supporting builders around the world creating crypto apps that scale. It is known for its fast transaction speeds and low costs, using a unique proof-of-history consensus mechanism.", sparkline: [] },
  { id: "btc", name: "Bitcoin", symbol: "BTC", price: 70338, change1h: 0.35, change1d: 4.21, fdv: 1.9e12, volume: 9.8e6, marketCap: 1.9e12, tvl: 0, description: "Bitcoin is a decentralized cryptocurrency originally described in a 2008 whitepaper by Satoshi Nakamoto. It was launched in January 2009 and is the world's first and most well-known digital currency.", sparkline: [] },
  { id: "bnb", name: "Binance Coin", symbol: "BNB", price: 662.29, change1h: 0.31, change1d: 6.37, fdv: 90.7e9, volume: 7.2e6, marketCap: 90.7e9, tvl: 45.2e6, description: "Binance Coin is the cryptocurrency issued by Binance exchange and trades with the BNB symbol. BNB runs on the BNB Chain and is used to pay transaction fees, participate in token sales, and more.", sparkline: [] },
  { id: "avax", name: "Avalanche", symbol: "AVAX", price: 9.17, change1h: 0.55, change1d: 3.18, fdv: 15.2e9, volume: 6.1e6, marketCap: 14.8e9, tvl: 32.1e6, description: "Avalanche is an open-source platform for launching decentralized applications and enterprise blockchain deployments in one interoperable, highly scalable ecosystem.", sparkline: [] },
  { id: "link", name: "Chainlink", symbol: "LINK", price: 8.86, change1h: 0.72, change1d: 5.44, fdv: 11.1e9, volume: 5.7e6, marketCap: 10.8e9, tvl: 18.7e6, description: "Chainlink is a decentralized oracle network that provides real-world data to smart contracts on the blockchain. It enables smart contracts to securely connect to external data sources, APIs, and payment systems.", sparkline: [] },
  ...
  { id: "arb", name: "Arbitrum", symbol: "ARB", price: 0.12, change1h: 0.44, change1d: 7.83, fdv: 4.6e9, volume: 3.8e6, marketCap: 3.7e9, tvl: 52.4e6, description: "Arbitrum is a Layer 2 scaling solution for Ethereum that aims to boost the speed and efficiency of Ethereum smart contracts while adding additional privacy features. It uses optimistic rollup technology.", sparkline: [] },
  { id: "op", name: "Optimism", symbol: "OP", price: 0.19, change1h: 0.63, change1d: 5.12, fdv: 4.1e9, volume: 3.5e6, marketCap: 2.9e9, tvl: 41.8e6, description: "Optimism is a Layer 2 scaling solution for Ethereum powered by optimistic rollups. It is designed to be the simplest and most powerful L2 scaling solution for Ethereum.", sparkline: [] },
  { id: "pol", name: "Polygon", symbol: "POL", price: 0.098, change1h: 0.38, change1d: -2.15, fdv: 3.8e9, volume: 2.9e6, marketCap: 3.6e9, tvl: 38.9e6, description: "Polygon (formerly Matic Network) is a protocol and framework for building and connecting Ethereum-compatible blockchain networks. It provides scalable solutions on Ethereum supporting a multi-chain ecosystem.", sparkline: [] },
];
